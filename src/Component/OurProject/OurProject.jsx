...
const OurProject = () => {
  const chemicals = {
    text: "Representatives of our company have been involved in the engineering and construction of large projects in many countries, in particular:    ",
    selectText:
  ...
  const projectCard = [
    {
      ...
      text: "2002 -1998",
      desc: "Shurtan gas-chemical complex. Production of ethylene and polyethylene for Uzbekneftegaz.",
    },
    {
      id: 2,
  ...
  const items = [
    ...
    {
      id: 2,
      text: "Legal and actual actions on issues related to the placement of objects",
    },
    {
      id: 3,
    ...
    {
      id: 6,
      text: "Legal and actual actions on the issues of object legalization (expertise) ",
    },
    {
      id: 7,
